...
# Nutrientes clave seleccionados para el modelo
nutrientes_modelo = [
...
# Puedes quitar triptófano si no tienes datos, pero es relevante para precisión y salud intestinal.

# Variables productivas recomendadas como outputs del modelo
productivos_modelo = [
...
if menu == "Modelo Predictivo":
    ...
    # Uploader y carga de datos históricos
    ...
    if archivo:
        ...
        if len(nutrientes_disponibles) < 7:  # mínimo de 7 nutrientes para robustez
            ...
            # Selección de nutrientes a usar
            ...
            if st.button("Entrenar modelo predictivo"):
                ...
                # Modelo - Random Forest y Regresión Lineal, elige el mejor
            ...
            if "modelo_predictivo" in st.session_state and st.session_state.get("variable_pred") == variable_pred:
                ...
                for nutr in st.session_state["nutrientes_usar"]:
                    ...
                    # Ajusta rangos para que el usuario no ponga valores irreales
                ...
                # (Opcional) Mostrar los valores históricos para la variable predicha
...
# Las otras secciones del menú ("Formulación de Dieta", "Simulador Productivo", etc.) se mantienen igual que en tu última versión.
# ... (incluye aquí el código anterior de las otras pestañas, que no fue modificado para brevedad)
